...
// BETA BUILD — **bold** / *italic* display markers (branch
// beta/markdown-markers). Installs alongside stable SyncNote.js;
// the toolbar function is SyncNoteBeta.
function SyncNoteBeta() {
  // ---------------------------------------------------------------------
  // Constants
  // ---------------------------------------------------------------------
  var SN_VERSION    = "0.27.0-beta";     // marker rendering BETA (KB §31)
